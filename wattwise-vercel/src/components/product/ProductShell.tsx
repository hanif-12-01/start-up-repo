  ...
  const groups: Array<{ label: string; items: Item[] }> = [
    {
      ...
      items: [
        ...(isMulti
          ? [
              { href: '/portfolio', label: 'Semua Usaha', icon: LayoutDashboard, tourId: 'sidebar-portfolio' },
              { href: '/dashboard', label: 'Lokasi Aktif', icon: Building2, tourId: 'sidebar-dashboard' },
            ]
          : [
